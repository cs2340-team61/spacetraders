...
public class JUnitTest {
    ...
    public void TechLevelCorrect() {
        ...
        String[] a = {"Pre-Agriculture" ,"Agriculture", "Medieval", "Renaissance",
    ...
    public void RecourseLevelCorrect() {
        ...
        List<String> z = new ArrayList<String>();
        String[] a = {"No Special Resources" ,"Mineral Rich", "Mineral Poor", "Desert",
                "Lots of Water", "Rich Soil", "Poor Soil", "Rich Fauna", "Lifeless",
